            ...
            <div className='container' style={{ backgroundColor: "#FFFFCC", marginTop: "60px", padding: "50px 0 40px" }}>
                <div className='grid wide'>
                    <div className="product-client__sidebar">
                        <img className="product-client__sidebar-left" src="https://server-shoptech.onrender.com/public/product-img/accessories-img/sidebar-left.png"></img>
                        <img className="product-client__sidebar-right" src="https://server-shoptech.onrender.com/public/product-img/accessories-img/sidebar-right.png"></img>
                    </div>
