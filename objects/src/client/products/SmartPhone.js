...
const SmartPhone = () => {
    ...
    const handleChangeBanner = () => {
        const arrayBanner = [
            "http://localhost:4000/public/product-img/smartphone-img/event-banner.png",
            "http://localhost:4000/public/product-img/smartphone-img/event-banner2.png",
            "http://localhost:4000/public/product-img/smartphone-img/event-banner3.png",
            "http://localhost:4000/public/product-img/smartphone-img/event-banner4.png"
        ]
        var index = 0;
    ...
    const arrayPromote = [
        "http://localhost:4000/public/product-img/smartphone-img/event-list-item4.png",
        "http://localhost:4000/public/product-img/smartphone-img/event-list-item3.png",
        "http://localhost:4000/public/product-img/smartphone-img/event-list-item5.png",
    ]
    var indexPromote = 0;
            ...
            <div className='container' style={{ backgroundColor: "#fcd8aa", marginTop: "60px", padding: "50px 0 40px" }}>
                <div className='grid wide'>
                    <div className="product-client__sidebar">
                        ...
                        <img className="product-client__sidebar-right" src="http://localhost:4000/public/product-img/smartphone-img/sidebar-right.png"></img>
                    </div>
                    <div className="product-client__event">
                        <img src="http://localhost:4000/public/product-img/smartphone-img/event-banner.png" alt="" className="product-client__event-primary"></img>

                        <div className="product-client__event-list">
                            <div className="product-client__event-col-left">
                                <img src="http://localhost:4000/public/product-img/smartphone-img/event-list-item.png" className="product-client__event-col-left-item"></img>
                                <img src="http://localhost:4000/public/product-img/smartphone-img/event-list-item2.png" className="product-client__event-col-left-item"></img>
                            </div>
                            ...
                            <div className="product-client__event-col-right">
                                ...
                                <img src="http://localhost:4000/public/product-img/smartphone-img/event-list-item3.png" className="product-client__event-col-right-item" ></img>
                                <button className="product-client__event-btn--next" onClick={handleNextPromote}>
                                    <i className="fa fa-arrow-right"></i>
                                </button>
                            </div>
                        </div>
                        <img className="product-client__event-gif" src="http://localhost:4000/public/product-img/smartphone-img/event-item-gif.gif" alt="ảnh gif" ></img>
                    </div>
                    ...
                    <div className='product-brand-list'>
                        <div className='product-client__brand'>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-iphone.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-samsung.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-xiaomi.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-oppo.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-realme.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-nokia.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-masstel.png"></img>
                            <img className='product-client__brand-item' src="http://localhost:4000/public/product-img/smartphone-img/logo-vivo.png"></img>
                        </div>
                    </div>
